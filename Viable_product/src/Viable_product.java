...
public class Viable_product extends Configured implements Tool{
	...
	repToRecordMap.put(new Long(sum), new Text(mykey));
		...
		public int run(String[] arg) throws Exception {
			...
			job.setJarByClass(Viable_product.class);
			job.setJobName("Top 5 viable product age wise");
		...
		public static void main(String[] ar)throws Exception {
			ToolRunner.run(new Configuration(),new Viable_product(),ar);
			System.exit(0);
